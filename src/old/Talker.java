...
public class Talker {
	 ...
	 */
	public String displayWinner(String playerOneHand, String playerTwoHand){
                return "You won! " + playerOneHand + " beats " + playerTwoHand;
	}
	 ...
	 * @param playerTwoHand contains a String showing players hand
	 */
	public String displayLoser(String playerOneHand, String playerTwoHand){
		return "You lost! " + playerOneHand + " loses to " + playerTwoHand;
	}
	 ...
	 * @param playerTwoHand contains a String showing players hand
	 */
	public String displayTie(String playerOneHand, String playerTwoHand){
		return "You tied! " + playerOneHand + " ties with " + playerTwoHand;
	}
